...
export class TaskboardComponent implements OnInit {
  ...
  sortProjects() {
    ...
    function ITasks(masterID: any) {



      //if (getTasks(masterID)) {
  ...
  //  this.tasksDataSource.data.map((data) => {

  //    if (data.master == "" || data.master == undefined) {

  //      projects_array.push(data)

  //    }
  //    else {
  //      unsorted_array.push(data)
  //    }
  ...
  //  projects_array.map((data) => {

  //    data.slave = getTasks(data._id)

  //    console.log(data.slave)

  //    data.slave.map((slave) => {

  //      console.log(slave)

  //      console.log(getTasks(slave._id), 'XXXXXXXXXXXXXX')

  //      slave.slave = getTasks(slave._id)

  //    })

  //    /*console.log(data.slave, 'xxxxxxxxxxxxxxxxxxxxx')*/

  //    //if (data.slave.length > 2) {
  ...
  //  this.tasksData.map((data) => {
  //    if (data.master == null || data.master == "") { 
  //      this.sortedData.push(data)
  //      console.log(this.sortedData, 'xxxxxxxxxxxxxxxx')

  //      } else {
  //        this.unsortedData.push(data)
  ...
  //  this.sortedData.map((master : any) => {
  //    this.unsortedData.map((slave: any) => {
  //      if (master._id == slave.master) {
  //        console.log('match')
  //        master.slave = []
  ...
  //  console.log(this.sortedData, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx')
  //  //console.log(this.sortedData)
  //  //console.log(this.unsortedData)
  //  //this.sortedData.map((outer) => {
  //  //  this.unsortedData.map((inner) => {
  //  //    console.log(outer._id, inner.master)
  //  //    if (outer._id == inner.master) {
          
  //  //      outer.slave.push(inner)
  //  //      console.log(outer.slave)
  //  //    }
  ...
  //  ////if (isUnique(data.project) == true) {
  //  ////  sorted.push(data.project)
  //  ////}


  //  //console.log(this.sortedData)

  //  this.tasksDataSource.data = this.sortedData
  //  this.unsortedDataSource.data = this.unsortedData
